<?php
	class Checkoutmodel {
	    ...
	    public function getOrder($currentOrderId){
	    	...
	    	$cmd = '
	    		SELECT id, customer_id, amount, ship_price, shipping_address, order_date, payment_data, status FROM chapinita.order WHERE id =:order_id
	    	';
			...
			$cmd = '
				...
				FROM chapinita.order_detail AS ot 
		...
		public function GetOrders(){
	    	...
	    	$cmd = '
	    		SELECT id, customer_id, amount, ship_price, shipping_address, order_date, payment_data, status, coupon, ship_date, shipper_tracking FROM chapinita.order
	    	';
	    ...
	    public function cancelOrder($orderId){
	    	...
	    	$cmd = '
	    		UPDATE chapinita.order SET status = 0 WHERE id =:orderId
	    	';
	    ...
	    public function setTracking($orderId, $tracking){
	    	...
	    	$cmd = '
	    		UPDATE chapinita.order SET status = 2, ship_date = now(), shipper_tracking =:tracking   WHERE id =:orderId
	    	';
	    ...
	    public function finalizeOrder($orderId){
	    	...
	    	$cmd = '
	    		UPDATE chapinita.order SET status = 3 WHERE id =:orderId
	    	';
